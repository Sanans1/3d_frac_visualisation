...
{
    public class LASReaderViewModel : ViewModelBase
    {
        #region fields
        ...
        /// </summary>
        public LASReaderViewModel(IDialogCoordinator dialogCoordinator)
        {
        ...
        private async void SelectLASFileAction(string filePath)
        {
            ...
            await Task.Run(() => 
            {
                ...
                _lasFileName = filePath.Substring(filePath.LastIndexOf('\\') + 1);
